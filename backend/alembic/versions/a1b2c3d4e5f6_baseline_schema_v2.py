...
Fresh baseline migration matching current models for PostgreSQL deployment.
"""
...
def upgrade() -> None:
    ...
    op.create_index('ix_like_reverse', 'likes', ['liked_user_id', 'user_id'], unique=False)
    ...
    op.create_index('ix_message_sender', 'messages', ['sender_id', 'sent_at'], unique=False)
    op.create_index('ix_message_recipient', 'messages', ['recipient_id', 'sent_at'], unique=False)
    ...
    op.create_index('ix_block_blocked_id', 'blocks', ['blocked_id'], unique=False)
